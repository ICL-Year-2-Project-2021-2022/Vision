...
module Qsys2_mm_interconnect_0_router_default_decode
  #(
...
module Qsys2_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD14 = log2ceil(64'h8001128 - 64'h8001120); 
    localparam PAD15 = log2ceil(64'h8001130 - 64'h8001128); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h8001130;
    ...
    Qsys2_mm_interconnect_0_router_default_decode the_default_decode(
    ...
    // ( 0x80010f0 .. 0x8001100 )
    if ( {address[RG:PAD11],{PAD11{1'b0}}} == 28'h80010f0  && read_transaction  ) begin
    ...
    // ( 0x8001128 .. 0x8001130 )
    if ( {address[RG:PAD15],{PAD15{1'b0}}} == 28'h8001128   ) begin
