...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../Qsys2.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x8001120
SOPC_SYSID_FLAG += --sidp=0x8001120
ELF_PATCH_FLAG  += --sidp 0x8001120

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1654854282
SOPC_SYSID_FLAG += --timestamp=1654854282
ELF_PATCH_FLAG  += --timestamp 1654854282
