...
module Qsys_fir_1_0 (
	...
	wire   [55:0] line_buffer_av_st_dout_0_data;          // line_buffer:av_st_dout_data_0 -> alg_core:av_st_din_data
	...
	wire   [41:0] scheduler_av_st_coeff_data;             // scheduler:av_st_coeff_data -> alg_core:av_st_coeff_data
	...
	alt_vip_line_buffer #(
		...
		.av_st_dout_data          (line_buffer_av_st_dout_data[55:0])        //             .data
	);

	Qsys_fir_1_0_alg_core alg_core (
		.clock                     (main_clock),                             //  main_clock.clk
		.reset                     (main_reset),                             //  main_reset.reset
