...
module Qsys_alt_vip_cl_mixer_0 #(
		...
		parameter IS_422                       = 1,
		parameter LIMITED_READBACK             = 1,
		parameter LOW_LATENCY_MODE             = 1,
		parameter DATA_PIPELINE_STAGES         = 4,
	...
	wire          user_demux0_av_st_dout_0_valid;         // user_demux0:av_st_dout_valid_0 -> alpha_merge0:av_st_din_valid
	wire   [55:0] user_demux0_av_st_dout_0_data;          // user_demux0:av_st_dout_data_0 -> alpha_merge0:av_st_din_data
	wire          user_demux0_av_st_dout_0_ready;         // alpha_merge0:av_st_din_ready -> user_demux0:av_st_dout_ready_0
	wire          user_demux0_av_st_dout_0_startofpacket; // user_demux0:av_st_dout_startofpacket_0 -> alpha_merge0:av_st_din_startofpacket
	wire          user_demux0_av_st_dout_0_endofpacket;   // user_demux0:av_st_dout_endofpacket_0 -> alpha_merge0:av_st_din_endofpacket
	...
	wire          user_demux1_av_st_dout_0_valid;         // user_demux1:av_st_dout_valid_0 -> alpha_merge1:av_st_din_valid
	wire   [55:0] user_demux1_av_st_dout_0_data;          // user_demux1:av_st_dout_data_0 -> alpha_merge1:av_st_din_data
	wire          user_demux1_av_st_dout_0_ready;         // alpha_merge1:av_st_din_ready -> user_demux1:av_st_dout_ready_0
	wire          user_demux1_av_st_dout_0_startofpacket; // user_demux1:av_st_dout_startofpacket_0 -> alpha_merge1:av_st_din_startofpacket
	wire          user_demux1_av_st_dout_0_endofpacket;   // user_demux1:av_st_dout_endofpacket_0 -> alpha_merge1:av_st_din_endofpacket
	...
	alt_vip_mixer_alpha_merge #(
		...
		.clock                    (main_clock_clk),                         // main_clock.clk
		.reset                    (main_reset_reset),                       // main_reset.reset
		.av_st_din_valid          (user_demux0_av_st_dout_0_valid),         //  av_st_din.valid
		.av_st_din_startofpacket  (user_demux0_av_st_dout_0_startofpacket), //           .startofpacket
		.av_st_din_endofpacket    (user_demux0_av_st_dout_0_endofpacket),   //           .endofpacket
		.av_st_din_data           (user_demux0_av_st_dout_0_data),          //           .data
		.av_st_din_ready          (user_demux0_av_st_dout_0_ready),         //           .ready
	...
	alt_vip_mixer_alpha_merge #(
		...
		.clock                    (main_clock_clk),                         // main_clock.clk
		.reset                    (main_reset_reset),                       // main_reset.reset
		.av_st_din_valid          (user_demux1_av_st_dout_0_valid),         //  av_st_din.valid
		.av_st_din_startofpacket  (user_demux1_av_st_dout_0_startofpacket), //           .startofpacket
		.av_st_din_endofpacket    (user_demux1_av_st_dout_0_endofpacket),   //           .endofpacket
		.av_st_din_data           (user_demux1_av_st_dout_0_data),          //           .data
		.av_st_din_ready          (user_demux1_av_st_dout_0_ready),         //           .ready
