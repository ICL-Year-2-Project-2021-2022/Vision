...
//Size parameters
parameter sub_factor = 32;
parameter clog_sub_factor = 5;

///////////////////////////////////////////////////////

logic [15:0] x_pixel, y_pixel;
logic [7:0]   red, green, blue;
logic[23:0] compressed, ram_data;
...
logic[8:0] wraddress, rdaddress, s_address_d;
...
always @(*) begin	
	...
	wraddress = {x_pixel[9:5], y_pixel[8:5]};
	rdaddress = s_address;
...
STREAM_REG_WB #(.DATA_WIDTH(26)) in_reg (
	.clk(clk),
	.rst_n(reset_n),
...
STREAM_REG_WB #(.DATA_WIDTH(26)) out_reg (
	.clk(clk),
	.rst_n(reset_n),
	.ready_out(out_ready),
