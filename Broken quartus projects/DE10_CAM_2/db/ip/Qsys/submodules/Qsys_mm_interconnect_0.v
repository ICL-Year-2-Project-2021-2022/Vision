...
module Qsys_mm_interconnect_0 (
	...
	wire          cmd_demux_src16_valid;                                                            // cmd_demux:src16_valid -> cmd_mux_016:sink2_valid
	wire  [113:0] cmd_demux_src16_data;                                                             // cmd_demux:src16_data -> cmd_mux_016:sink2_data
	wire          cmd_demux_src16_ready;                                                            // cmd_mux_016:sink2_ready -> cmd_demux:src16_ready
	wire   [16:0] cmd_demux_src16_channel;                                                          // cmd_demux:src16_channel -> cmd_mux_016:sink2_channel
	wire          cmd_demux_src16_startofpacket;                                                    // cmd_demux:src16_startofpacket -> cmd_mux_016:sink2_startofpacket
	wire          cmd_demux_src16_endofpacket;                                                      // cmd_demux:src16_endofpacket -> cmd_mux_016:sink2_endofpacket
	wire          cmd_demux_001_src0_valid;                                                         // cmd_demux_001:src0_valid -> cmd_mux_016:sink0_valid
	wire  [113:0] cmd_demux_001_src0_data;                                                          // cmd_demux_001:src0_data -> cmd_mux_016:sink0_data
	wire          cmd_demux_001_src0_ready;                                                         // cmd_mux_016:sink0_ready -> cmd_demux_001:src0_ready
	wire   [16:0] cmd_demux_001_src0_channel;                                                       // cmd_demux_001:src0_channel -> cmd_mux_016:sink0_channel
	wire          cmd_demux_001_src0_startofpacket;                                                 // cmd_demux_001:src0_startofpacket -> cmd_mux_016:sink0_startofpacket
	wire          cmd_demux_001_src0_endofpacket;                                                   // cmd_demux_001:src0_endofpacket -> cmd_mux_016:sink0_endofpacket
	...
	wire  [113:0] cmd_demux_src6_data;                                                              // cmd_demux:src6_data -> crosser:in_data
	...
	wire  [113:0] crosser_out_data;                                                                 // crosser:out_data -> cmd_mux_006:sink0_data
	...
	wire  [113:0] rsp_demux_006_src0_data;                                                          // rsp_demux_006:src0_data -> crosser_001:in_data
	wire          rsp_demux_006_src0_ready;                                                         // crosser_001:in_ready -> rsp_demux_006:src0_ready
	wire   [16:0] rsp_demux_006_src0_channel;                                                       // rsp_demux_006:src0_channel -> crosser_001:in_channel
	...
	wire  [113:0] crosser_001_out_data;                                                             // crosser_001:out_data -> rsp_mux:sink6_data
	wire          crosser_001_out_ready;                                                            // rsp_mux:sink6_ready -> crosser_001:out_ready
	wire   [16:0] crosser_001_out_channel;                                                          // crosser_001:out_channel -> rsp_mux:sink6_channel
	...
	wire          terasic_auto_focus_0_mm_ctrl_agent_rdata_fifo_src_valid;                          // TERASIC_AUTO_FOCUS_0_mm_ctrl_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] terasic_auto_focus_0_mm_ctrl_agent_rdata_fifo_src_data;                           // TERASIC_AUTO_FOCUS_0_mm_ctrl_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire          terasic_auto_focus_0_mm_ctrl_agent_rdata_fifo_src_ready;                          // avalon_st_adapter_005:in_0_ready -> TERASIC_AUTO_FOCUS_0_mm_ctrl_agent:rdata_fifo_src_ready
	...
	wire          eee_imgproc_0_s1_agent_rdata_fifo_src_valid;                                      // EEE_IMGPROC_0_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_014:in_0_valid
	wire   [33:0] eee_imgproc_0_s1_agent_rdata_fifo_src_data;                                       // EEE_IMGPROC_0_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_014:in_0_data
	wire          eee_imgproc_0_s1_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_014:in_0_ready -> EEE_IMGPROC_0_s1_agent:rdata_fifo_src_ready
	...
	Qsys_mm_interconnect_0_cmd_mux_016 cmd_mux_016 (
		...
		.sink2_ready         (cmd_demux_src16_ready),                        //     sink2.ready
		.sink2_valid         (cmd_demux_src16_valid),                        //          .valid
		.sink2_channel       (cmd_demux_src16_channel),                      //          .channel
		.sink2_data          (cmd_demux_src16_data),                         //          .data
		.sink2_startofpacket (cmd_demux_src16_startofpacket),                //          .startofpacket
		.sink2_endofpacket   (cmd_demux_src16_endofpacket)                   //          .endofpacket
	);
	...
	Qsys_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (altpll_0_c2_clk),                              //       clk.clk
		.reset              (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Qsys_mm_interconnect_0_cmd_demux_001 rsp_demux_008 (
		.clk                (altpll_0_c2_clk),                              //       clk.clk
		.reset              (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Qsys_mm_interconnect_0_cmd_demux_001 rsp_demux_009 (
		.clk                (altpll_0_c2_clk),                              //       clk.clk
		.reset              (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Qsys_mm_interconnect_0_cmd_demux_001 rsp_demux_011 (
		.clk                (altpll_0_c2_clk),                              //       clk.clk
		.reset              (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Qsys_mm_interconnect_0_cmd_demux_001 rsp_demux_012 (
		.clk                (altpll_0_c2_clk),                              //       clk.clk
		.reset              (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Qsys_mm_interconnect_0_cmd_demux_001 rsp_demux_013 (
		.clk                (altpll_0_c2_clk),                              //       clk.clk
		.reset              (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Qsys_mm_interconnect_0_cmd_demux_001 rsp_demux_015 (
		.clk                (altpll_0_c2_clk),                              //       clk.clk
		.reset              (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Qsys_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (altpll_0_c2_clk),                              // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (eee_imgproc_0_s1_agent_rdata_fifo_src_data),   //     in_0.data
		.in_0_valid     (eee_imgproc_0_s1_agent_rdata_fifo_src_valid),  //         .valid
		.in_0_ready     (eee_imgproc_0_s1_agent_rdata_fifo_src_ready),  //         .ready
