...
void obtainExpectedObservation(size_t state_size, float pred_state[state_size][1], int x_coor, int y_coor, float delta[2], float exp_dis_ang[2], float* q);
...
void getPredictedStateFromKalmanGain(size_t state_size, int land_dist, int land_ang, float kalman_gain[state_size][2], float exp_dis_ang[2], float pred_state[state_size][1]);
